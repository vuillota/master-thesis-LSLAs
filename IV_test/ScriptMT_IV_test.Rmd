...
From the relative suitability computed for each crop in each raster
cell, it is possible to compute average crop suitability in the land
polygons.
...
compute the price index for each land in our sample.
...
Tvolution of land deals and price index in the world. Up to 2015, it
